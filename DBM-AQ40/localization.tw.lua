...
L:SetOptionLocalization{
	...
	WarnClawTentacle		= "为利爪觸鬚顯示警告",
	WarnGiantEyeTentacle	= "为巨型眼球觸鬚顯示警告",
	WarnGiantClawTentacle	= "为巨型利爪觸鬚顯示警告",
	SpecWarnWeakened		= "當首領虛弱時顯示特別警告",
	TimerEyeTentacle		= "為下一次眼球觸鬚顯示計時器",
	TimerClawTentacle		= "为下一次利爪觸鬚顯示計時器",
	TimerGiantEyeTentacle	= "为下一次巨型眼球觸鬚顯示計時器",
	TimerGiantClawTentacle	= "为下一次巨型利爪觸鬚顯示計時器",
